...
MM.settings = {
    ...
    showSync: function() {
        var settings = [
            ...
            {id: "sync_lang_now", type: "button", label: MM.lang.s("forcelangsync"), handler: MM.lang.sync},
            {id: "sync_css_now", type: "button", label: MM.lang.s("forcecsssync"), handler: MM.sync.css}
        ];
    ...
    showGeneral: function() {
        ...
        var settings = [
            {id: "general_purgecaches", type: "button", label: MM.lang.s("purgecaches"), handler: MM.cache.purge},
            {
                ...
                config: {
                    ...
                    min: 0,
                    max: 600,
                    value: MM.config.cache_expiration_time / 100000,
